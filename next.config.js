...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(), payment=()" },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://*.supabase.in https://*.vercel.app https://rawcdn.githack.com https://raw.githack.com",
      "connect-src 'self' https://*.supabase.co https://*.supabase.in wss://*.supabase.co https://graph.facebook.com https://api.twilio.com https://*.vercel.app https://vercel.live https://vitals.vercel-insights.com https://rawcdn.githack.com https://raw.githack.com",
