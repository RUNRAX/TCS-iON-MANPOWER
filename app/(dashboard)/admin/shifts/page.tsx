        ...
        {showCreate && (
          <>
            ...
            <motion.div
              ...
              style={{ position: "fixed", inset: 0, zIndex: 50, backdropFilter: "blur(8px) saturate(120%)", WebkitBackdropFilter: "blur(8px) saturate(120%)", background: dark ? "rgba(3,2,10,0.60)" : "rgba(15,8,30,0.22)" }}
